...
using Tyuiu.ZakharovaYV.Sprint3.Task5.V15.Lib;
namespace Tyuiu.ZakharovaYV.Sprint3.Task5.V15
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Используя вложенные циклы решить уравнение                              *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
